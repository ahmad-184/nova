  ...
  return (
    <Card className="w-full max-w-sm">
      <CardHeader>
        ...
        <CardDescription>
          Verify your <span className="text-primary font-normal">N</span>ova
      ...
      <CardFooter>
        <div className="w-full text-center justify-center text-sm">
          <Link
            href="/sign-up"
            className="hover:underline hover:text-blue-500 text-primary flex items-center justify-center gap-0"
          >
            Back to Sign Up
          </Link>
        </div>
